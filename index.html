    ...
    <body>
        <div id="overlay" class="overlay">
            <div class="overlay-body">
                <p class="overlay-title">Aceite os termos para prosseguir</p>

                <p class="overlay-description">Uso de cookies: Utilizamos cookies e tecnologias similares para melhorar a funcionalidade do site e fornecer uma experiência personalizada. Os cookies são pequenos arquivos de texto armazenados no seu dispositivo que nos permitem reconhecer informações específicas sobre sua visita e preferências. Você pode optar por desativar os cookies nas configurações do seu navegador, mas isso pode afetar o funcionamento adequado do site</p>

                <p class="overlay-description">Medidas de segurança: Empregamos medidas técnicas e organizacionais adequadas para proteger suas informações pessoais contra acesso não autorizado, uso indevido, divulgação, alteração ou destruição. No entanto, é importante ressaltar que nenhum método de transmissão ou armazenamento de dados é completamente seguro<b>podemos garantir a segurança absoluta das informações transmitidas ou armazenadas</b>.</p>

                <div class="overlay-buttons-wrapper">
                    <div id="accept-button" class="overlay-button">Aceitar</div>
                    <div id="decline-button" class="overlay-button">Sair</div>
                </div>
